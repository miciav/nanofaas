...
impl IdempotencyStore {
    ...
    pub fn get_execution_id(&mut self, function_name: &str, key: &str, now_millis: u64) -> Option<String> {
    ...
    pub fn put_with_timestamp(&mut self, function_name: &str, key: &str, execution_id: &str, now_millis: u64) {
        self.keys.insert(
