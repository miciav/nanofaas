...
IMAGE_MATRIX: dict[str, ImageTarget] = {t.name: t for t in [
    ...
    _gradle("java-word-stats", ":functions:java:word-stats:bootBuildImage", "functionImage", "Java Functions"),
    _gradle("java-json-transform", ":functions:java:json-transform:bootBuildImage", "functionImage", "Java Functions"),
    _docker("java-lite-word-stats", "functions/java/word-stats-lite/Dockerfile", "Java Lite Functions"),
    _docker("java-lite-json-transform", "functions/java/json-transform-lite/Dockerfile", "Java Lite Functions"),
    _docker("go-word-stats", "functions/go/word-stats/Dockerfile", "Go Functions"),
    _docker("go-json-transform", "functions/go/json-transform/Dockerfile", "Go Functions"),
    _docker("python-word-stats", "functions/python/word-stats/Dockerfile", "Python Functions"),
    _docker("python-json-transform", "functions/python/json-transform/Dockerfile", "Python Functions"),
    _docker("javascript-word-stats", "functions/javascript/word-stats/Dockerfile", "JavaScript Functions"),
    _docker("javascript-json-transform", "functions/javascript/json-transform/Dockerfile", "JavaScript Functions"),
    _docker("watchdog", "watchdog/Dockerfile", "Runtime"),
    _docker("bash-word-stats", "functions/bash/word-stats/Dockerfile", "Bash Functions"),
    _docker("bash-json-transform", "functions/bash/json-transform/Dockerfile", "Bash Functions"),
]}
