...
from controlplane_tool.core.models import CliTestScenarioName, RuntimeKind
...
CLI_TEST_VM_BACKED_SCENARIOS = frozenset({"cli-stack", "host-platform"})
CLI_TEST_FUNCTION_SELECTION_SCENARIOS = frozenset({"cli-stack", "deploy-host"})
