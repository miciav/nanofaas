...
from controlplane_tool.scenario.scenario_helpers import function_image, function_payload, selected_functions
...
def _cli_binary(context: CliComponentContext) -> str:
    ...
    return str(
        context.repo_root / "clients" / "cli" / "build" / "install" / "nanofaas-cli" / "bin" / "nanofaas-cli"
    )
