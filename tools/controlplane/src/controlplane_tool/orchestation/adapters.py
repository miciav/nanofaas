...
from controlplane_tool.building.gradle_ops import CommandResult, GradleOps
from controlplane_tool.loadtest.k6_ops import K6Ops
from controlplane_tool.loadtest.loadtest_bootstrap import LoadtestBootstrap, LoadtestBootstrapContext
...
class ShellCommandAdapter:
    ...
    # ------------------------------------------------------------------
    # Gradle / building / test delegation
    # ------------------------------------------------------------------
