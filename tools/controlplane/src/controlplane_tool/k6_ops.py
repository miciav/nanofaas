...
from controlplane_tool.gradle_ops import CommandResult, run_logged
from controlplane_tool.loadtest_models import LoadProfileDefinition, LoadtestRequest
...
class K6Ops:
    ...
    def run_loadtest_k6(
        ...
        from controlplane_tool.loadtest_models import TargetRunResult
