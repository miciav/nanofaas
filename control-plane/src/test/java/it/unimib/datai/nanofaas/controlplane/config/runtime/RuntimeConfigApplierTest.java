...
class RuntimeConfigApplierTest {
    ...
    private static final SyncQueueProperties DEFAULT_PROPS = new SyncQueueProperties(
            true, true, 200, Duration.ofSeconds(5), Duration.ofSeconds(2), 2, Duration.ofSeconds(30), 50
    );
    ...
    void applySuccess_updatesRateLimiterAndMetrics() {
        ...
        RuntimeConfigService configService = new RuntimeConfigService(rateLimiter, DEFAULT_PROPS);
